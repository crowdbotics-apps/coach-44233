"""
Django settings for coach_44233 project.
...
WSGI_APPLICATION = 'coach_44233.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "coach_44233 API",
    "DESCRIPTION": "API documentation for coach_44233 App",
    "VERSION": "v1",
}
